 ...
 * @author
 */
public class BingMvpDataBean implements Parcelable {

    public static final Parcelable.Creator<BingMvpDataBean> CREATOR = new Parcelable.Creator<BingMvpDataBean>() {
        @Override
        public BingMvpDataBean createFromParcel(Parcel source) {
            return new BingMvpDataBean(source);
        }

        @Override
        public BingMvpDataBean[] newArray(int size) {
            return new BingMvpDataBean[size];
        }
    };
    /**
     * code : 1
    ...
    public BingMvpDataBean() {
    }

    protected BingMvpDataBean(Parcel in) {
